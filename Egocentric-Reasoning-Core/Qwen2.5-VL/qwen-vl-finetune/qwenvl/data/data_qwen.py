...
def preprocess_qwen_2_visual(
    ...
    system_message = "You are an expert video analyzer. Answer the multiple choice question by giving ONLY the letter identifying the answer. Example: A or B or C or D or E. You MUST answer even if unsure."
